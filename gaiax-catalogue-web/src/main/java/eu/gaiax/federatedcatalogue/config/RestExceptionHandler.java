...
import eu.gaiax.federatedcatalogue.exception.*;
import eu.gaiax.federatedcatalogue.model.response.CommonResponse;
import eu.gaiax.federatedcatalogue.model.response.ErrorResponse;
import eu.gaiax.federatedcatalogue.model.response.ValidationErrorResponse;
...
public class RestExceptionHandler {
    ...
    @ExceptionHandler({HttpMessageNotReadableException.class, BadDataException.class, HttpRequestMethodNotSupportedException.class, MissingServletRequestParameterException.class})
